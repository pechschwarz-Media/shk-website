...
const config: Config = {
    darkMode: ['class'],
    content: ['./src/pages/**/*.{js,ts,jsx,tsx,mdx}', './src/components/**/*.{js,ts,jsx,tsx,mdx}', './src/app/**/*.{js,ts,jsx,tsx,mdx}', './node_modules/@relume_io/relume-ui/dist/**/*.{js,ts,jsx,tsx}'],
    theme: {
        fontFamily: {
        ...
        fontSize: {
            ...
            h4: 'clamp(1.25rem, 1.0385rem + 1.2821vw, 2rem)',
            h5: '1.5rem',
            h6: '1.25rem',
