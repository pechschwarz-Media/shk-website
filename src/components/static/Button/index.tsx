  ...
  "group inline-flex justify-center items-center gap-x-3 disabled:opacity-50 focus-visible:outline-2 focus-visible:outline-offset-2",
  {
    variants: {
      variant: {
        ...
        whiteOutline:
          "bg-transparent border border-white text-white h-12 rounded-full px-5 backdrop-blur-md",
        blueOutline:
          "bg-transparent border border-customer text-customer h-12 rounded-full px-5 backdrop-blur-md",
      },
    },
    defaultVariants: {
      variant: "blueFilled",
...
type AsLinkProps = Omit<
  React.AnchorHTMLAttributes<HTMLAnchorElement> & { as: "link"; link: AcfLink },
  "href"
>;
