...
export default function Posts_2_Inner({ content, title }: { content: Content; title: string }) {
  return (
    <Section
      dataComponent="Posts_2"
      settings={{ padding: { top: "off", bottom: "off" }, preventAnimation: true }}
    >
        ...
        <div className="relative text-white w-full">
          <div className="container">
            <div className="max-w-xl">
              <h1 className="text-h1 leading-tight font-light mb-8">{title}</h1>
