                                ...
                                {content?.email && (
                                    <li>
                                        <Link href={`mailto:${content?.email}`} className="inline-flex gap-4">
                                            <svg className="relative top-[2px]" width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                ...
                                {content?.phone && (
                                    <li>
                                        <Link href={`tel:${content?.phone}`} className="inline-flex gap-4">
                                            <svg className="relative top-[2px]" width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                ...
                                {content?.address && (
                                    <li>
                                        <div className="inline-flex gap-4">
                                            <svg className="relative top-[2px]" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
