...
export default function Locations_Inner({
  ...
  return (
    <Section
      ...
      settings={{ padding: { top: "medium", bottom: "medium" }, preventAnimation: true }}
    >
      <div className="pt-20">
                      ...
                      return (
                        <div className="border border-blue rounded-lg overflow-hidden" key={index}>
                          <div className="p-4">
                            ...
                            <div className="text-large font-headline mb-3">
                              {parse(location.title?.rendered)}
                            </div>
                            ...
                            <Link
                              href={location?.link}
                              className="flex items-center gap-2 text-blue mt-5"
                            >
                              Weitere Details
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
