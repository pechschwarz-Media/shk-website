...
export default function Locations_Inner({
    ...
    function sortByDistance(locations: Location[], coordinates: { lat: number; lng: number }) {
        return locations
            .map((location) => ({
                ...location,
                distance: getDistance(coordinates, { lat: parseFloat(location?.acf?.lat), lng: parseFloat(location?.acf?.lng) }),
            }))
                                            ...
                                            {locations.map((location, index) => {
                                                return (
                                                    <AdvancedMarker
                                                        ...
                                                        onClick={() => {
                                                            setCoordinates({ lat: parseFloat(location.acf.lat), lng: parseFloat(location.acf.lng) });
                                                            setStatus('OK');
                                                        }}
                                                        key={index}
                                                    />
